...
> [!CAUTION]
> **No Browser Usage**: Do **NOT** use browser tools (subagents, page reading) to interact with GitHub or monitor the PR. Use MCP GitHub tools or the `gh` CLI exclusively. Using the browser for GitHub is prohibited as it is inefficient and prone to error.
> [!DANGER]
